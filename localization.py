...
MESSAGES = {
    'khmer': {
        ...
        'daily_executive_summary_report': (
            ...
            "💎 Total Equity: **${total_equity:,.2f} USDT**\n\n"
            "💰 **24-HOUR PERFORMANCE:**\n"
            ...
            "🚀 Turbo Hedge HFT: {turbo_status}\n"
            "   └ 1-Tap Copy ដើម្បីបើកដំណើរការ ៖ `` `/turbo_hedge ON 50 10 1234` ``\n"
            "🧠 SmartX AI Quant Suite: {smartx_status}\n"
            "   └ 1-Tap Copy ដើម្បីបើកដំណើរការ ៖ `` `/smartx ON 50 10 1234` ``\n"
            "📊 24/7 Auto-Trade Radar: {auto_trade_status}\n"
            "   └ 1-Tap Copy ដើម្បីបើកដំណើរការ ៖ `` `/auto_trade ON 30 1234` ``\n"
            "⚡ Aave V3 Flash Loan Keeper: {flash_loan_status}\n"
            "   └ 1-Tap Copy ដើម្បីបើកដំណើរការ ៖ `` `/flash_loan_keeper AUTO ON 1234` ``\n"
            "🌾 Perpetual Funding Harvester: {funding_status}\n"
            "   └ 1-Tap Copy ដើម្បីបើកដំណើរការ ៖ `` `/funding_harvester ON 1234` ``\n"
            "🛡️ Dynamic Trailing & Liquidation Guard: {guard_status}\n"
            "   └ 1-Tap Copy ដើម្បីបើកដំណើរការ ៖ `` `/trailing_guard ON 1234` ``\n"
            "⚡ Smart Swap DEX MEV Shield: {swap_status}\n"
            "   └ 1-Tap Copy ដើម្បីបើកដំណើរការ ៖ `` `/smart_swap AUTO 50 1234` ``\n"
            "🐋 Whale Pre-Pump Radar: {pre_pump_status}\n"
    ...
    'english': {
        ...
        'daily_executive_summary_report': (
            ...
            "🤖 **SUPER SMART ENGINES STATUS (24/7 Silent):**\n"
            "🚀 Turbo Hedge HFT: {turbo_status}\n"
            "   └ 1-Tap Copy to activate: `` `/turbo_hedge ON 50 10 1234` ``\n"
            "🧠 SmartX AI Quant Suite: {smartx_status}\n"
            "   └ 1-Tap Copy to activate: `` `/smartx ON 50 10 1234` ``\n"
            "📊 24/7 Auto-Trade Radar: {auto_trade_status}\n"
            "   └ 1-Tap Copy to activate: `` `/auto_trade ON 30 1234` ``\n"
            "⚡ Aave V3 Flash Loan Keeper: {flash_loan_status}\n"
            "   └ 1-Tap Copy to activate: `` `/flash_loan_keeper AUTO ON 1234` ``\n"
            "🌾 Perpetual Funding Harvester: {funding_status}\n"
            "   └ 1-Tap Copy to activate: `` `/funding_harvester ON 1234` ``\n"
            "🛡️ Dynamic Trailing & Liquidation Guard: {guard_status}\n"
            "   └ 1-Tap Copy to activate: `` `/trailing_guard ON 1234` ``\n"
            "⚡ Smart Swap DEX MEV Shield: {swap_status}\n"
            "   └ 1-Tap Copy to activate: `` `/smart_swap AUTO 50 1234` ``\n"
            "🐋 Whale Pre-Pump Radar: {pre_pump_status}\n"
    ...
    'chinese': {
        ...
        'daily_executive_summary_report': (
            ...
            "🤖 **SUPER SMART ENGINES STATUS (24/7 Silent):**\n"
            "🚀 Turbo Hedge HFT: {turbo_status}\n"
            "   └ 一键快捷开启 ៖ `` `/turbo_hedge ON 50 10 1234` ``\n"
            "🧠 SmartX AI Quant Suite: {smartx_status}\n"
            "   └ 一键快捷开启 ៖ `` `/smartx ON 50 10 1234` ``\n"
            "📊 24/7 Auto-Trade Radar: {auto_trade_status}\n"
            "   └ 一键快捷开启 ៖ `` `/auto_trade ON 30 1234` ``\n"
            "⚡ Aave V3 Flash Loan Keeper: {flash_loan_status}\n"
            "   └ 一键快捷开启 ៖ `` `/flash_loan_keeper AUTO ON 1234` ``\n"
            "🌾 Perpetual Funding Harvester: {funding_status}\n"
            "   └ 一键快捷开启 ៖ `` `/funding_harvester ON 1234` ``\n"
            "🛡️ Dynamic Trailing & Liquidation Guard: {guard_status}\n"
            "   └ 一键快捷开启 ៖ `` `/trailing_guard ON 1234` ``\n"
            "⚡ Smart Swap DEX MEV Shield: {swap_status}\n"
            "   └ 一键快捷开启 ៖ `` `/smart_swap AUTO 50 1234` ``\n"
            "🐋 Whale Pre-Pump Radar: {pre_pump_status}\n"
