            ...
            if not args or len(args) == 0:
                ...
                if user_lang == 'en':
                    ...
                    msg = (
                        ...
                        "• 🚀 **TURBO Sprint** ៖ `XAUUSDT` (Dynamic 25x-50x, 2-Stage Scale-Out: 50% TP1 Cash + 50% Moonbag)\n"
                        "• 🛡️ **SONIC Scalp** ៖ `XAUUSDT` (Leverage 10x-20x, 87.12% Win Rate, Golden 85% Ratchet)\n"
            ...
            if is_spot:
                ...
                if mode_label == "TURBO":
                    ...
                    ack_text = (
                        ...
                        f"  • Profit Target: `2-Stage Scale-Out (50% TP1 Cash + 50% Moonbag)`\n"
                        f"🛡️ *Risk Shield*  : `Breakeven Armor @ +2.5% ROI | Golden 85% Ratchet`\n"
                        f"{div}\n"
                    ...
                    ack_text = (
                        ...
                        f"🛡️ *Risk Shield*  : `2-Stage Scale-Out + Golden 85% Ratchet Armor`\n"
                        f"{div}\n"
                        ...
                        if sig.get("side") in ["BUY", "SELL"]:
                            ...
                            if exec_res.get("status") in ["success", "NEW", "FILLED"] or exec_res.get("orderId"):
                                ...
                                notif = (
                                    ...
                                    f"• Target TP  : `2-Stage Scale-Out (50% TP1 Cash + 50% Moonbag)`\n"
                                    f"• Protection : `Breakeven Armor @ +2.5% ROI | Golden 85% Ratchet`\n"
                                    f"{div}\n"
