    ...
    def run(self):
        ...
        async def admin_signal_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
            ...
            if not args or len(args) < 2:
                if user_lang == 'en':
                    ...
                    guide_card = (
                        "🚨 **APEX SUPER AGI v12.00 | 主跟单信号广播跟单系统** 🚨\n"
                        "═══════════════════════════════\n\n"
                        "📊 **信号跟单分发规范：**\n"
        ...
        async def admin_reset_pin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
            ...
            if not args or len(args) < 2:
                if user_lang == 'en':
                    guide_card = (
                        "🔒 **APEX SUPER AGI v12.00 | ADMIN 2FA PIN RESET ENGINE** 🔒\n"
                        "═══════════════════════════════\n\n"
                    ...
                    guide_card = (
                        "🔒 **APEX SUPER AGI v12.00 | ADMIN 2FA 重置控制台** 🔒\n"
                        "═══════════════════════════════\n\n"
                        "📊 **安全重置规范：**\n"
            ...
            if not args or len(args) == 0:
                ...
                if user_lang == 'en':
                    ...
                    msg = (
                        ...
                        "👉 **🛒 Spot Multi-Coin Breakout (ប្រើប្រាស់តែ Spot Cash 0% Liquidation) ៖**\n`` `/turbo_hedge SPOT TOP 50 1234` ``\n"
                        "👉 **🛒 Spot Single-Coin Mode ៖**\n`` `/turbo_hedge SPOT SOL 50 1234` ``\n"
